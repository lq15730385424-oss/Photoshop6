<!-- registry-sync: version=10.8.0; skills=1442; stars=35690; updated_at=2026-04-29T16:59:33+00:00 -->
# 🌌 Antigravity Awesome Skills: 1,442+ Agentic Skills for Claude Code, Gemini CLI, Cursor, Copilot & More

> **Installable GitHub library of 1,442+ agentic skills for Claude Code, Cursor, Codex CLI, Gemini CLI, Antigravity, and other AI coding assistants.**
...
- **Broad coverage with real utility**: 1,442+ skills across development, testing, security, infrastructure, product, and marketing.
...
- [Browse 1,442+ Skills](#browse-1442-skills)
...
If you want a faster answer than "browse all 1,442+ skills", start with a tool-specific guide:
